...
TemplateLastSavedVersion=Version 12.0.0.034.00  Supports 128 bit SSL 
Agendas=WebLOAD confluence non vdi;
Start Time=1568013327
Report Resolution=20
Terminate Time=1568013629
Return code=0
Failure reason=Test passed
SessionCreatedVersion=Version 12.0.0.034.00  Supports 128 bit SSL           
SessionLastSavedVersion=Version 12.0.0.034.00  Supports 128 bit SSL           
[WebLOAD confluence non vdi]
Path=C:\Users\bharadwaj.mudumba\Documents\WebLOAD\Sessions\WebLOAD confluence non vdi.wls
RelativePath=.\WebLOAD confluence non vdi.wls
ExecutionType=0
LimitRun=0
IsMix=0
MixScriptSelection=2
AssistentItemAAString_1=5 '11 EndLoadSize '1 1 '13 StartLoadSize '1 1 '16 AssistantCaption '21 Linear Schedule Model '13 ScheduleModel '1 0 '9 TotalTime '1 5 
Schedule_1=1
From_1=00000000
To_1=00000500
LoadSize_1=1
LoadMachines=localhost;
[WebLOAD confluence non vdi : Browser Emulation]
...
EnforceEncoding=0
bGZipSupport=0
[WebLOAD confluence non vdi : Authentication]
UserName=
PassWord=
NTUserName=
NTUserPassword=
...
ProxyHost=
ProxyPort=
[WebLOAD confluence non vdi : Options\Connection]
Speed for LG=0
Speed for PC=0
Advanced=0
...
[WebLOAD confluence non vdi : Diagnostic]
Start Round=1
End Round=1
Output Dir=
Syntax Check=0
...
RTT Report Issues=1
[WebLOAD confluence non vdi : Raw Data]
...
Raw Data CSV=0
[WebLOAD confluence non vdi : FunctionalTesting]
...
nCompareImages=0
nCompareTables=0
[WebLOAD confluence non vdi : ClientType]
clientType=5
getImages=1
UseClientJSFull=1
UseClientJSOptim=0
JavaFull=0
JavaOptimized=0
[WebLOAD confluence non vdi : PassFailDefinition]
definitionType=1
checkErrors=0
checkSevere=1
checkStopTest=0
...
warningNum=15
SLANum=15
[WebLOAD confluence non vdi : SleepTimeControl]
sleepControlType=1
timeBetween=2
timeAnd=11
deviationPersent=10
...
[WebLOAD confluence non vdi : TerminateRound]
AlwaysCompleteRound=0
AlwaysCompleteInitClient=0
RoundTimeoutWarning=1800
RoundTimeoutError=0
[WebLOAD confluence non vdi : Java]
strSelectedJVM=Default
[WebLOAD confluence non vdi : WebServices]
sBasicPassword=
sUserName=
sProxyHost=
sProxyPassword=
...
sProxyPort=
nWSClientType=1
[WebLOAD confluence non vdi : ResetMechanism]
bResetEnable=0
nCreateLGRetryTimes=3
nLGTimeout=150
nResetTimeout=60
nStopLGTimeout=3
[WebLOAD confluence non vdi : HTTPParameters]
bHTTPVersion=1
bMultiIPSupport=0
bEncodeFormData=1
bAcceptLanguage=0
StrAcceptLanguage=
[WebLOAD confluence non vdi : BrowserCache]
bFilterApplets=1
bFilterImages=1
bFilterJSFiles=1
...
bFilterDynamicPC=0
nCacheTypePC=3
[WebLOAD confluence non vdi@localhost]
StationType=PC
OperatingSystem=NT
ClientType=2
Type=Emulation
